	...
	static function data_export_callback() {
  	...
  	static function captcha_settings_callback() {
		...
		if ( self::$form_options['recaptcha_enable']  == 'true' && (self::$global_options['recaptcha_public_key'] == '' || self::$global_options['recaptcha_secret_key'] == '') ) {
			echo '<div class="fsc-error">';
			echo __( 'Warning: Enabling this setting requires the "reCAPTCHA keys" to also be set.', 'si-contact-form' );
			echo "</div>\n";
		}
		?>

		<label for="recaptcha_public_key"><?php _e( 'reCAPTCHA Public Key', 'si-contact-form' ); ?>:</label>
		...
		<?php _e( 'The key your site serves to users.', 'si-contact-form' ); ?>
		</div>
		<br />
		...
		<?php _e( 'For communication between your site and Google.', 'si-contact-form' ); ?>
		</div>
		<br />

        <?php _e( '<a href="https://www.google.com/recaptcha/intro/" target="_new">Get reCAPTCHA keys for your site here</a>', 'si-contact-form' ); ?>
...
//		echo "This is the backup/export settings section";
	...
	static function validate( $text ) {
        ...
        self::$global_options['recaptcha_public_key'] = preg_replace( '/[^a-z0-9_-]/i', '', $_POST['recaptcha_public_key'] );
        self::$global_options['recaptcha_secret_key'] = preg_replace( '/[^a-z0-9_-]/i', '', $_POST['recaptcha_secret_key'] );
